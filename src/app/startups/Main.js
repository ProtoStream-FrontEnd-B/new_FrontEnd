...
const Main = () => {
    return (
        <div className="start_page">
            <StartupCard head="Startup" para=" “Innovation distinguishes between a leader and a follower.” " btn1="Know about Startup" btn2="Register Startup Idea"  route2= "/startups/CYB" route1 = "/resources"/>
